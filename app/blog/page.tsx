        ...
        <div className="mx-auto max-w-7xl px-6 pb-16 md:pb-24">
          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-[0.95fr_0.75fr] lg:items-end">
            <h1 className="max-w-4xl text-5xl font-semibold leading-[0.98] tracking-tight md:text-7xl">
              Research security insights for universities.
            </h1>
            <p className="text-lg leading-8 text-muted-foreground">
              Guides, analysis, and product thinking for teams building a more
              consistent research security due diligence process.
            </p>
          </div>
        </div>
      </section>
          ...
          {posts.length === 0 ? (
            <div className="rounded-[24px] border border-border bg-card p-8">
              ...
              <p className="mt-3 text-muted-foreground">
                The blog is ready for category education, launch notes, and
                research security playbooks.
              </p>
            </div>
          ) : (
