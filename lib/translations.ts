...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Tracer cross-references 320+ sources and 400M+ records automatically and delivers a",
    ...
    value: {
      speed: {
        ...
        description: "Tracer cross-references 320+ sources and 400M+ records automatically — sanctions lists, academic networks, corporate structures, adverse OSINT signals.",
      },
      consistency: {
        label: "Consistency",
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: "Tracer référence plus de 320 sources et 400M+ de données automatiquement et génère un",
    ...
    value: {
      speed: {
        ...
        description: "Tracer vérifie automatiquement plus de 320 sources (400M+ de données) — listes de sanctions, réseaux académiques, structures corporatives, signaux OSINT défavorables.",
      },
      consistency: {
        label: "Cohérence",
