  ...
  en: {
    ...
    value: {
      speed: {
        ...
        description: "Tracer cross-references 400M+ records across 320+ sources — sanctions lists, academic networks, corporate structures, adverse OSINT signals.",
      },
      consistency: {
        label: "Consistency",
  ...
  fr: {
    ...
    value: {
      speed: {
        ...
        description: "Tracer vérifie plus de 400M+ de données à travers 320 sources — listes de sanctions, réseaux académiques, structures corporatives, signaux OSINT défavorables.",
      },
      consistency: {
        label: "Cohérence",
