...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Tracer checks 50+ sources (450M+ records) automatically and delivers a",
    ...
    value: {
      speed: {
        ...
        description: "Tracer checks 50+ sources (450M+ records) automatically — sanctions lists, academic networks, corporate structures, adverse OSINT signals.",
      },
      consistency: {
        label: "Consistency",
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: "Tracer analyse plus de 50 sources (450M+ de données) automatiquement et génère un",
    ...
    value: {
      speed: {
        ...
        description: "Tracer vérifie automatiquement plus de 50 sources (450M+ de données) — listes de sanctions, réseaux académiques, structures corporatives, signaux OSINT défavorables.",
      },
      consistency: {
        label: "Cohérence",
