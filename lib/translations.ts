...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Tracer cross-references 400M+ records across 320+ sources automatically and delivers a",
    ...
    value: {
      speed: {
        ...
        description: "Tracer cross-references 400M+ records across 320+ sources automatically — sanctions lists, academic networks, corporate structures, adverse OSINT signals.",
      },
      consistency: {
        label: "Consistency",
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: "Tracer référence plus de 400M+ de données à travers 320 sources automatiquement et génère un",
    ...
    value: {
      speed: {
        ...
        description: "Tracer vérifie automatiquement plus de 400M+ de données à travers 320 sources — listes de sanctions, réseaux académiques, structures corporatives, signaux OSINT défavorables.",
      },
      consistency: {
        label: "Cohérence",
