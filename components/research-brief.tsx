              ...
              <div ref={briefRef} className="relative pt-8 pb-4" style={{ transform: `perspective(1000px) rotateX(${tiltX}deg) translateY(${translateY}px)`, transformOrigin: "center bottom", transition: "transform 75ms ease-out" }}>
                ...
                <div className="relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-lg shadow-zinc-300/30 dark:shadow-2xl dark:shadow-black/40 overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-zinc-200/80 dark:border-white/[0.06] flex items-center justify-between">
                    ...
                    <span className="text-[9px] px-2 py-0.5 bg-emerald-600 dark:bg-emerald-500/20 text-white dark:text-emerald-400 rounded font-medium">{t.brief.complete}</span>
                  </div>
                  ...
                  <div className="px-4 py-3 border-b border-zinc-200/80 dark:border-white/[0.06]">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between py-1.5">
                        ...
                        <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 bg-emerald-600 dark:bg-emerald-500/15 text-white dark:text-emerald-400 rounded font-medium"><CheckCircle2 className="h-2.5 w-2.5" />{t.brief.clear}</span>
                      </div>
                      <div className="flex items-center justify-between py-1.5 border-t border-zinc-100 dark:border-white/[0.04]">
                        ...
                        <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 bg-amber-500 dark:bg-amber-500/15 text-white dark:text-amber-400 rounded font-medium"><AlertTriangle className="h-2.5 w-2.5" />{t.brief.review}</span>
                      </div>
                      <div className="flex items-center justify-between py-1.5 border-t border-zinc-100 dark:border-white/[0.04]">
                      ...
                      <div className="flex items-center justify-between py-1.5 border-t border-zinc-100 dark:border-white/[0.04]">
                        ...
                        <span className="flex items-center gap-1 text-[10px] px-2 py-0.5 bg-red-600 dark:bg-red-500/15 text-white dark:text-red-400 rounded font-medium"><AlertTriangle className="h-2.5 w-2.5" />7 flags</span>
                      </div>
                    </div>
                  </div>
